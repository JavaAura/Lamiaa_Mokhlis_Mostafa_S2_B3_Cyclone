...
class TestAuth {
    ...
    void testLoginValidCredentials() {
        ...
        assertEquals(email, result.get().getEmail(), "The returned user's email should match the input email");
    }
    ...
    void testLoginInvalidCredentials() {
        ...
        assertFalse(result.isPresent(), "User should not be found for invalid credentials");
    }
}
